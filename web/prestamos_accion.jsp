...
<%
    ...
    if(accion.equals("Grabar")){
            String rut = request.getParameter("txtRut");
            String codigo = request.getParameter("txtCodigo");
            String fecptmo = request.getParameter("datFptmo");
            String fecdevol = request.getParameter("datFdevol");
            String stock = request.getParameter("txtStock");
            try{
                Connection conn = Conectar();    
                Statement st1 = conn.createStatement();     
                String sql = "INSERT INTO t_prestamos (pre_libro, pre_alu_rut, pre_fec_ptmo, pre_fec_devo) VALUES ('"+codigo+"','"+rut+"',CURRENT_DATE,'"+fecdevol+"')";
                try{
                st1.execute(sql);
                out.write("PRESTAMO INSERTADO SATISFACTORIAMENTE...");
                }
                catch (Exception e){
